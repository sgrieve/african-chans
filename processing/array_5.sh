...
number=$SGE_TASK_ID
paramfile=/data/home/faw513/african-chans/processing/array_params.txt
...
# Run the application.
sh /data/home/faw513/african-chans/processing/runner.sh $variable1 $variable2 $variable3 $variable4 $variable5 $variable6
